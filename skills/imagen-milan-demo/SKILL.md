...
2. **Delegate Image Generation**: After modifying the prompt, use the `nano-banana-pro` skill (sometimes called `nano-banana-ricc`) to do the actual image heavy lifting.
